 ...
 *
 * The objective of the program is to define the InventoryProduct class 
 * that holds a collection of inventory records using the private data 
 * members, constructors, accessor and mutator methods, method overloading
 * as well as all methods to handle the calculations needed for the class  
 * 
 */
