 ...
 *
 * The objective of the program is to define the ClassSequentialInventoryProduct
 * class that is needed in order to create a product inventory sequential file
 * that holds a collection of inventory records/ products by opening, writing 
 * data to  a destination, reading data back from a source, and closing the file
 * 
 */
