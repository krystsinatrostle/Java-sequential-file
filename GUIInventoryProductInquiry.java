 ...
 *
 * The objective of the program is to define the GUIInventoryProductInquiry 
 * class that reads the records from the file and displays product inventory 
 * queries from each record contained in the inventory data file as well as 
 * the calculated fileds until the user ends the program. It accepts commands 
 * from the user's screen, displays all the fields for the record, and 
 * interfaces with the InventoryProduct class. 
 * 
 */
